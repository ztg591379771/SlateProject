 ...
 * 
 */
class MYPROJECT1_API SMySComboButton : public SMenuAnchor
{

public:

	SLATE_BEGIN_ARGS(SMySComboButton)
	...
	SLATE_STYLE_ARGUMENT(FComboButtonStyle, ComboButtonStyle)
		...
		//-----------------------------------------------------------------------user-define-----------------------------
		SLATE_ARGUMENT(const FSlateBrush*, DefaultImage)
...
protected:
	...
	//--------------------------------------------------------------user-defined---------------------------------------------
	//get auto image
	const FSlateBrush* GetMyImage() const;
	//Default 
	const FSlateBrush* DefaultImage;
	//Hovered
